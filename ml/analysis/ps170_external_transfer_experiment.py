    ...
    domain_compatibility_assessments = [
        {
            ...
            "assessment_type": "DOMAIN_COMPATIBILITY_ASSESSMENT",
            "assessment_disclaimer": "Layer compatibility labels describe ARCHITECTURAL algorithmic compatibility only. No actual NASA dataset was loaded or evaluated. This is NOT an empirical transfer result.",
            ...
            "layer_compatibility": {
                "layer_1_static_limits": "ARCHITECTURALLY_COMPATIBLE",
                "layer_2_pat_mad": "ARCHITECTURALLY_COMPATIBLE_WITH_LOT_CALIBRATION",
                "layer_3_copod": "ARCHITECTURALLY_COMPATIBLE",
                "layer_4_isolation_forest": "ARCHITECTURALLY_COMPATIBLE",
                "layer_5_xgboost_supervised": "DOES_NOT_TRANSFER_ZERO_SHOT",
                "layer_6_gpr_prognostics": "ARCHITECTURALLY_COMPATIBLE_PHYSICS_KERNEL",
                "layer_7_physics_engine": "ARCHITECTURALLY_COMPATIBLE",
                "layer_8_governed_decision_pathway": "ARCHITECTURALLY_COMPATIBLE",
            },
            "layer_compatibility_evidence_type": "ARCHITECTURAL_SCENARIO_ANALYSIS",
            "overall_status": "PARTIAL_ARCHITECTURAL_COMPATIBILITY_PHYSICS_AND_ANOMALY_LAYERS",
            "notes": "Physics and unsupervised anomaly layers are architecturally compatible with discrete power device domains. Supervised XGBoost tree model does NOT zero-shot transfer. No actual NASA dataset was evaluated; this is an architectural analysis only.",
        },
        {
            ...
            "assessment_type": "DOMAIN_COMPATIBILITY_ASSESSMENT",
            "assessment_disclaimer": "Layer compatibility labels describe ARCHITECTURAL algorithmic compatibility only. No actual UCI SECOM dataset was loaded or evaluated.",
            "input_feature_contract": {
            ...
            "layer_compatibility": {
                ...
                "layer_2_pat_mad": "ALGORITHM_ONLY_NO_FEATURE_MAPPING",
                "layer_3_copod": "CURSE_OF_DIMENSIONALITY",
                "layer_4_isolation_forest": "ALGORITHM_ONLY_NO_FEATURE_MAPPING",
        ...
        },
        {
            ...
            "assessment_type": "DOMAIN_COMPATIBILITY_ASSESSMENT",
            "assessment_disclaimer": "Layer compatibility labels describe ARCHITECTURAL algorithmic compatibility only. No actual ST-AWFD dataset was loaded or evaluated. This is NOT an empirical transfer result.",
            "input_feature_contract": {
            ...
            "layer_compatibility": {
                ...
                "layer_2_pat_mad": "ARCHITECTURALLY_COMPATIBLE_SPATIAL_PAT",
                "layer_3_copod": "ARCHITECTURALLY_COMPATIBLE",
                "layer_4_isolation_forest": "ARCHITECTURALLY_COMPATIBLE",
                "layer_5_xgboost_supervised": "DOES_NOT_TRANSFER_ZERO_SHOT",
                "layer_6_gpr_prognostics": "DOES_NOT_TRANSFER",
                "layer_7_physics_engine": "NOT_APPLICABLE",
                "layer_8_governed_decision_pathway": "ARCHITECTURALLY_COMPATIBLE_SPATIAL_HOLD",
            },
            "layer_compatibility_evidence_type": "ARCHITECTURAL_SCENARIO_ANALYSIS",
            "overall_status": "PARTIAL_ARCHITECTURAL_COMPATIBILITY_SPATIAL_AND_ANOMALY_LAYERS",
            "notes": "Spatial PAT and genealogy discrimination are architecturally compatible with ST-AWFD wafer map analysis. No actual ST-AWFD dataset was evaluated; this is an architectural analysis only.",
        },
    ]
