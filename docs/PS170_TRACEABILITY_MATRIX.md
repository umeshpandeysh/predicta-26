...
| **PS170-05** | **Physics Consistency Engine** | `src/api/inference.js`<br>`src/physics/reliability_engine.py` | `tests/test_js_python_parity.js`<br>`tests/test_physics_reliability_engine.py` | `ml/training/run_exp05_physics_fusion.js` | `ml/reports/ps170_layer_ablation_report.json` |
