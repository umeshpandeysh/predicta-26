...
| **PS170-04** | **168h Prognostics & Uncertainty** | `src/prognostics/gpr_forecast.js`<br>`src/prognostics/gpr_forecast.py` | `tests/test_prognostic_stability.js`<br>`tests/test_prognostics.py` | `ml/prognostics/evaluate_multi_lot_stability.py` | `experiments/prognostics/multi_lot_conformal_stability_report.json` |
