...
| **PS170-02** | **Dynamic Outlier Screening (PAT/COPOD)** | `src/api/inference.js`<br>`src/api/inference_service.py` | `tests/test_js_python_parity.js`<br>`tests/test_inference_service.py` | `ml/analysis/run_anomaly_benchmark.py` | `experiments/anomaly_benchmark_report.json` |
...
| **PS170-04** | **168h GPR Prognostics & Uncertainty** | `src/prognostics/gpr_forecast.js`<br>`src/prognostics/gpr_forecast.py` | `tests/test_prognostic_stability.js`<br>`tests/test_prognostics.py` | `ml/prognostics/evaluate_multi_lot_stability.py` | `experiments/prognostics/multi_lot_conformal_stability_report.json` |
| **PS170-05** | **Physics Consistency Engine** | `src/physics/reliability_engine.js`<br>`src/physics/reliability_engine.py` | `tests/test_physics_boundaries.py`<br>`tests/test_physics_reliability_engine.py` | `ml/training/run_exp05_physics_fusion.js` | `ml/reports/ps170_layer_ablation_report.json` |
...
| **PS170-09** | **Engineering Evidence Card & Counterfactual** | `src/governance/evidence_card.js`<br>`src/governance/evidence_card.py` | `tests/test_ps170_intelligence.js`<br>`tests/test_ps170_intelligence.py` | `src/demo_ps170_traceability.js` | `ml/reports/ps170_latent_escape_report.json` |
