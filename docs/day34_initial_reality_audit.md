...
| **Pre-Inference Data Quality** | 🟢 **REAL + VERIFIED** | Pre-inference validation gate (`src/ingestion/data_quality_gate.js`). | Rejects malformed/impossible inputs ($temp > 175^\circ C$) HTTP 400. |
