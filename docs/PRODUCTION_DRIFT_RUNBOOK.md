...
- **Express Health Endpoint**: Displays authoritative operating threshold 0.20 matching production model metadata. Inference calculations utilize lot Z-score normalized features.
