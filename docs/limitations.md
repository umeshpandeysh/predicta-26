...
*   **Dataset Constraints:** The system has been validated on a physics-informed synthetic dataset (\`SEMICONDUCTOR_TELEMETRY-synthetic-v0.1\`) and public proxy datasets (NASA, STMicroelectronics, UCI SECOM). It has not been validated on proprietary High-Reliability Semiconductor spaceflight-grade logs, as such data was not provided.
