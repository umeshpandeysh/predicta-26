...
| **Workflow Validation** | `tests/test_workflow_validation.js` | Chaos testing (NaN, Infinity, equipment OHE) | Fab MES workstation authorization tokens | **MODERATE (Post-Production)** |
