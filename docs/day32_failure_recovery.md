# Predicta Day 32 — Failure Recovery & Fault Isolation Report
...
| **Data Quality Violation** | $temp = 300^\circ C$ or missing mandatory field | Intercepted by Pre-Inference Data Quality Gate | 🟢 Returns HTTP 400 `DATA_QUALITY_REJECTED` prior to ML. |
