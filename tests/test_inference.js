...
console.log("=========================================================================");
console.log("PREDICTA V2 PRODUCTION CONTRACT — ML INFERENCE API TEST SUITE");
console.log("=========================================================================\n");
...
try {
  ...
  assert.strictEqual(inferenceService.operatingThreshold, 0.20, "2. Operating threshold incorrect (Expected 0.20)");
  console.log("✔ Test 02 Passed: Operating threshold verified at authoritative 0.20");
  ...
  assert.strictEqual(res1.threshold, 0.20, "3. Expected threshold 0.20");
  ...
  assert.throws(() => inferenceService.predictSingle(malformed), /must be a valid finite number|DATA_QUALITY_REJECTED/, "7. Should reject malformed number");
  console.log("✔ Test 07 Passed: Malformed numeric string rejected with Error");

  // Test 8: Threshold matches authoritative v2 configuration
  assert.strictEqual(inferenceService.operatingThreshold, 0.20, "8. Threshold altered!");
  console.log("✔ Test 08 Passed: Threshold matches authoritative v2 configuration (0.20)");
  ...
  // Test 11: Explicit v2 Threshold Contract Test (0.19 -> PASS, 0.20 -> FAIL, 0.21 -> FAIL)
  assert.strictEqual(0.19 >= inferenceService.operatingThreshold ? "FAIL" : "PASS", "PASS", "11. 0.19 should yield PASS");
  assert.strictEqual(0.20 >= inferenceService.operatingThreshold ? "FAIL" : "PASS", "FAIL", "11. 0.20 should yield FAIL");
  assert.strictEqual(0.21 >= inferenceService.operatingThreshold ? "FAIL" : "PASS", "FAIL", "11. 0.21 should yield FAIL");
  console.log("✔ Test 11 Passed: v2 threshold contract (0.19 -> PASS, 0.20 -> FAIL, 0.21 -> FAIL) verified");

  console.log("\n=========================================================================");
  console.log("ALL 11 INFERENCE API TESTS PASSED SUCCESSFULLY! ✅");
  console.log("=========================================================================\n");
} catch (err) {
